...
export async function POST(request) {
  try {
    ...
    console.log('Stripe checkout request:', { tierId, billingPeriod, userId, userEmail })
    ...
    // Check if user already has a Stripe customer ID in profiles table
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      subscription_data: {
        ...
        // Note: Don't set trial_period_days to 0 - Stripe requires minimum 1 or omit entirely
      },
