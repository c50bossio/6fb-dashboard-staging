          ...
          <div className="text-center space-y-6">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <div className="flex items-start space-x-2">
                <svg className="w-5 h-5 text-amber-800 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="flex space-x-2 justify-center">
                  <button
                    ...
                    className="px-3 py-1 text-sm bg-olive-600 text-white rounded hover:bg-olive-700 focus:outline-none focus:ring-2 focus:ring-olive-500"
                  >
                    Copy Codes
                  </button>
                  <button
            ...
            <div className="bg-olive-50 border border-olive-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-olive-700 mt-2 space-y-1 text-left">
            ...
            <button
              ...
              className="w-full bg-moss-600 text-white py-3 px-4 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 font-medium"
            >
              Complete Setup
            </button>
          </div>
