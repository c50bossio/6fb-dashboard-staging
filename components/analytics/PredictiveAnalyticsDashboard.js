        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-blue-50 rounded-lg p-4">
              <div className="text-sm font-medium text-blue-800 mb-2">Retention Rate</div>
            ...
            <div className="bg-purple-50 rounded-lg p-4">
              <div className="text-sm font-medium text-purple-800 mb-2">Lifetime Value</div>
              <div className="text-xl font-bold text-purple-900">
                {formatCurrency(predictiveData.customer_behavior_forecast.customer_lifetime_value.predicted_6_months)}
              </div>
              <div className="text-xs text-purple-700">6-month projection</div>
            </div>
          </div>
        </div>
