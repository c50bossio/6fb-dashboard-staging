      ...
      <div className="section-padding bg-white dark:bg-card">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">Information We Collect</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">How We Use Your Information</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">Information Sharing</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">Data Security</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">Your Rights</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">Contact Us</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <div className="bg-gray-50 dark:bg-muted rounded-lg p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">Email: privacy@6fb.ai</p>
