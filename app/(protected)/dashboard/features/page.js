          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {features.map((feature, index) => (
              <div key={feature.name} className="feature-card group">
                <div className="flex">
                  <div className="bg-gradient-to-br from-olive-50 to-gold-50 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:from-olive-100 group-hover:to-gold-100 transition-all duration-300 flex-shrink-0">
