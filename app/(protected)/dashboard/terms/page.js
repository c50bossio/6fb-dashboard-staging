      ...
      <div className="section-padding bg-white dark:bg-card">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">Acceptance of Terms</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">Service Description</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">User Responsibilities</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">As a user of our service, you agree to:</p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">Subscription and Billing</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">Limitation of Liability</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">Service Availability</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">Termination</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">Changes to Terms</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-card-foreground mb-4">Contact Information</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <div className="bg-gray-50 dark:bg-muted rounded-lg p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">Email: legal@6fb.ai</p>
              <p className="text-gray-600 dark:text-gray-300">Phone: +1 (555) 6FB-AI</p>
              <p className="text-gray-600 dark:text-gray-300">Address: San Francisco, CA</p>
            </div>
          </div>
        </div>
      </div>
