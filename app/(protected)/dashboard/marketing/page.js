            ...
            <div className="flex justify-between items-center py-6">
              <div className="flex items-center">
                <Link href="/dashboard" className="mr-4">
                  <ArrowLeftIcon className="h-6 w-6 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:text-card-foreground" />
                </Link>
                <div>
                  <h1 className="text-3xl font-bold text-gray-900 dark:text-card-foreground">Marketing Campaigns</h1>
                  <p className="mt-1 text-gray-600 dark:text-gray-300">Manage your marketing automation</p>
                </div>
              </div>
              <button 
                onClick={() => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 mb-8">
            <div className="bg-white dark:bg-card rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-gray-900 dark:text-card-foreground">{metrics.totalCampaigns}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-card rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-gray-900 dark:text-card-foreground">{metrics.activeCampaigns}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-card rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-gray-900 dark:text-card-foreground">{metrics.totalSent}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-card rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-gray-900 dark:text-card-foreground">{metrics.avgOpenRate}%</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-card rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Click Rate</p>
                  <p className="text-2xl font-semibold text-gray-900 dark:text-card-foreground">{metrics.avgClickRate}%</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-card rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-gray-900 dark:text-card-foreground">{metrics.totalConversions}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-card shadow rounded-lg">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-border">
              <h2 className="text-lg font-medium text-gray-900 dark:text-card-foreground">All Campaigns</h2>
            </div>
                ...
                <tbody className="bg-white dark:bg-card divide-y divide-gray-200">
                  {campaigns.map((campaign) => (
                    <tr key={campaign.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-500 dark:text-gray-300">{campaign.type}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
          ...
          {/* AI Recommendations */}
          <div className="mt-8 bg-white dark:bg-card rounded-lg shadow p-6">
            <h3 className="text-lg font-medium text-gray-900 dark:text-card-foreground mb-4">AI Marketing Insights</h3>
