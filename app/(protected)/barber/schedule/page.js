    ...
    return (
      <div className={`border rounded-lg p-3 ${
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm font-medium text-gray-900 dark:text-card-foreground">{time}</span>
          {isBooked && (
        ...
        {appointment && (
          <div className="mt-2">
            <p className="text-sm font-medium text-gray-900 dark:text-card-foreground">{appointment.customer_name}</p>
            <p className="text-xs text-gray-600 dark:text-gray-300">{appointment.service_name}</p>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-muted">
      ...
      <div className="bg-white dark:bg-card shadow-sm border-b">
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-card-foreground">My Schedule</h1>
              <p className="text-sm text-gray-600 dark:text-gray-300">Manage your appointments and availability</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white dark:bg-card rounded-xl shadow-sm border border-gray-200 dark:border-border p-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-card-foreground mb-4">Time Slots</h3>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-card rounded-xl shadow-sm border border-gray-200 dark:border-border p-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-card-foreground mb-4">Weekly Availability</h3>
            ...
            {/* Quick Stats */}
            <div className="bg-white dark:bg-card rounded-xl shadow-sm border border-gray-200 dark:border-border p-6 mt-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-card-foreground mb-4">Today's Summary</h3>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600 dark:text-gray-300">Total Appointments</span>
