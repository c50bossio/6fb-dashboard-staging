    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Loading website settings...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <BuildingStorefrontIcon className="h-6 w-6 text-olive-600 dark:text-olive-400" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-olive-500 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      <span className="text-gray-500 dark:text-gray-400 mr-2">6fb.com/shop/</span>
                      <input
                        type="text"
                        value={settings.slug}
                        onChange={(e) => setSettings({ ...settings, slug: e.target.value.toLowerCase().replace(/\s+/g, '-') })}
                        className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-olive-500 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100"
                      />
                    </div>
                  </div>
                </div>
                    ...
                    <div key={day} className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          className="h-4 w-4 text-olive-600 focus:ring-indigo-500 border-gray-300 dark:border-gray-600 rounded"
                        />
                        ...
                        {!hours.closed && (
                          <>
                            <input
                              ...
                              className="px-2 py-1 border border-gray-300 dark:border-gray-600 rounded text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100"
                            />
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center hover:border-gray-400 dark:hover:border-gray-500 cursor-pointer bg-white dark:bg-gray-900">
                  ...
                  {themeTemplates.map((template) => (
                    <label
                      ...
                      className={`flex items-start p-4 border rounded-lg cursor-pointer hover:bg-background ${
                        settings.theme_template === template.id
                          ? 'border-olive-500 bg-indigo-50 dark:bg-indigo-900/30'
                    ...
                    >
                      <input
                        ...
                        className="mt-1 h-4 w-4 text-olive-600 focus:ring-indigo-500 border-gray-300 dark:border-gray-600"
                      />
                      <div className="ml-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-3">
                      <input
                        ...
                        className="h-10 w-20 border border-gray-300 dark:border-gray-600 rounded cursor-pointer bg-white dark:bg-gray-900"
                      />
                      <input
                        type="text"
                        value={settings.primary_color}
              ...
              <div className="space-y-4">
                {barberPages.length > 0 ? (
                  barberPages.map((barber) => (
                    <div key={barber.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-white dark:bg-gray-900">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            <h3 className="font-medium text-gray-900 dark:text-gray-100">{barber.name}</h3>
                  ...
                  <div className="py-8 text-center text-gray-500 dark:text-gray-400">
                    <UsersIcon className="h-12 w-12 mx-auto mb-3 text-gray-400 dark:text-gray-500" />
        ...
        {activeTab === 'preview' && (
          <div className="space-y-6">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className={`p-2 rounded ${previewMode === 'desktop' ? 'bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'}`}
                  >
                  ...
                  <button
                    ...
                    className={`p-2 rounded ${previewMode === 'mobile' ? 'bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'}`}
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="border border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden">
                  <div className="bg-gray-100 dark:bg-gray-700 px-4 py-2 border-b border-gray-200 dark:border-gray-600">
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="flex-1 bg-white dark:bg-gray-800 rounded px-3 py-1 text-sm text-gray-600 dark:text-gray-400 truncate">
                        6fb.com/shop/{settings.slug}
                      </div>
                    </div>
                  </div>

                  <div className="bg-white dark:bg-gray-900" style={{ minHeight: '600px' }}>
                    ...
                    <div className="p-8">
                      <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100" style={{ fontFamily: settings.heading_font }}>
                        {settings.about_title}
                      </h2>
                      <p className="text-gray-600 dark:text-gray-400" style={{ fontFamily: settings.body_font }}>
                    ...
                    {settings.show_team && (
                      <div className="p-8 bg-gray-50 dark:bg-gray-800">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6" style={{ fontFamily: settings.body_font }}>
                          {settings.services_description}
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          {['Classic Cut', 'Fade', 'Beard Trim'].map((service) => (
                            <div key={service} className="bg-white dark:bg-gray-900 p-4 rounded-lg shadow border border-gray-200 dark:border-gray-700">
                              <h3 className="font-medium text-gray-900 dark:text-gray-100">{service}</h3>
                              {settings.show_pricing && <p className="text-gray-500 dark:text-gray-400">$35</p>}
                            </div>
                          ))}
                        </div>
                      </div>
            ...
            <div className="bg-olive-50 dark:bg-olive-900/30 rounded-lg p-4">
