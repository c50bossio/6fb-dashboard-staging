...
// Simple navigation component for this page
function CalendarNavigation() {
  return (
    <nav className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-gray-900">BookedBarber Calendar</h1>
        </div>
        <div className="flex space-x-4">
          <a href="/dashboard" className="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
            Dashboard
          </a>
          <a href="/customers" className="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
            Customers
          </a>
          <a href="/calendar" className="bg-olive-100 text-olive-800 px-3 py-2 rounded-md text-sm font-medium">
            Calendar
          </a>
        </div>
      </div>
