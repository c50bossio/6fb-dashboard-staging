...
export async function GET(request) {
  try {
      ...
      return new Response(`
        ...
        <body>
          <div class="container">
            ...
            <p class="error">Google Calendar connection was cancelled or failed.</p>
    ...
    // This requires backend Google Calendar integration service
    const result = {
      success: false,
      error: 'Google Calendar integration requires backend service implementation'
    }
      ...
      return new Response(`
        ...
        <body>
          <div class="container">
            ...
            <p class="success">Your Google Calendar has been connected to 6FB.</p>
