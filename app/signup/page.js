...
// Simple redirect component from /signup to /subscribe
export default function SignUpRedirectPage() {
  ...
  useEffect(() => {
    ...
    const redirectUrl = queryString ? `/subscribe?${queryString}` : '/subscribe'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sand-200 via-white to-sand-100 flex items-center justify-center p-4">
      <div className="text-center">
        ...
        <p className="text-olive-600">Redirecting to signup...</p>
      </div>
    </div>
  )
}