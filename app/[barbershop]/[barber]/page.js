        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                <ScissorsIcon className="h-6 w-6 mr-2 text-amber-600" />
                Services & Pricing
              </h2>
            ...
            {portfolio.length > 0 && (
              <div className="bg-white rounded-xl shadow p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                  <PhotoIcon className="h-6 w-6 mr-2 text-amber-600" />
                  Portfolio
                </h2>
            ...
            {reviews.length > 0 && (
              <div className="bg-white rounded-xl shadow p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                  <ChatBubbleLeftIcon className="h-6 w-6 mr-2 text-amber-600" />
                  Customer Reviews
                </h2>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow p-6">
              ...
              <button
                onClick={() => setShowBookingModal(true)}
                className="w-full mt-4 px-4 py-2 bg-amber-600 text-white font-semibold rounded-lg hover:bg-amber-700 transition-colors"
              >
              ...
              <div className="space-y-3">
                ...
                {contact_info.phone && (
                  <div className="flex items-center space-x-3">
                    ...
                    <a href={`tel:${contact_info.phone}`} className="text-sm text-amber-600 hover:text-amber-700">
                      {contact_info.phone}
                    </a>
                  </div>
                )}
            ...
            <div className="p-6">
              ...
              <div className="flex justify-end space-x-3 mt-6">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-amber-600 text-white font-semibold rounded-lg hover:bg-amber-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
                >
                  Continue
                </button>
              </div>
