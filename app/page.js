...
export default function Dashboard() {
  ...
  const quickActions = [
    { name: 'Send SMS Campaign', icon: DevicePhoneMobileIcon, path: '/campaigns/sms' },
    { name: 'Send Email Blast', icon: EnvelopeIcon, path: '/campaigns/email' },
    { name: 'Manage Customers', icon: UserGroupIcon, path: '/customers' },
    { name: 'View Analytics', icon: ChartBarIcon, path: '/analytics' },
    { name: 'Schedule Posts', icon: SparklesIcon, path: '/social' },
