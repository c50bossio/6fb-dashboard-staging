    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid gap-4">
          ...
          <div className="p-4 bg-gray-800 rounded">
            <h3 className="font-semibold mb-2">Option 10: Fixed Callback</h3>
            <p className="text-sm text-gray-400 mb-3">Complete solution with bypass flags for dashboard access</p>
            <button
              onClick={() => signInWithGoogle('/auth/callback-fixed')}
          ...
          <div className="p-4 bg-gray-800 rounded border-2 border-green-500">
            <h3 className="font-semibold mb-2 text-green-400">⭐ Option 11: Server Callback (RECOMMENDED)</h3>
            <p className="text-sm text-gray-400 mb-3">Uses server-side exchange with better error handling</p>
            <button
              onClick={() => signInWithGoogle('/auth/callback-server')}
