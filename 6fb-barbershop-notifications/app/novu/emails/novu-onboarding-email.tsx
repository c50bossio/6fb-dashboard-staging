...
import { emailControlSchema, payloadSchema } from "../workflows/welcome-onboarding-email/schemas";
import { z } from "zod";

type NovuWelcomeEmailProps = z.infer<typeof emailControlSchema> & z.infer<typeof payloadSchema>;
...
export function renderEmail(controls: z.infer<typeof emailControlSchema>, payload: z.infer<typeof payloadSchema>) {
