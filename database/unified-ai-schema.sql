-- Unified AI Tables for Supabase PostgreSQL
...
CREATE INDEX idx_knowledge_docs_embedding ON knowledge_documents USING hnsw (embedding vector_cosine_ops);
...
-- Function to search knowledge documents using vector similarity
...
-- with proper indexes, RLS policies, and helper functions for AI operations.