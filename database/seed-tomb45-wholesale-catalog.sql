...
-- First, ensure master_products table has tier_pricing column
...
-- Add subscription_tier to marketplace_enrollment if not exists
ALTER TABLE marketplace_enrollment 
ADD COLUMN IF NOT EXISTS subscription_tier TEXT DEFAULT 'free';

-- Insert Tomb45 Wholesale Products (Row 1: Core Styling)
...
-- Row 2: Professional Care Products
...
INSERT INTO audit_logs (
  ...
  'SEED_DATA',
  'master_products', 
  '{"action": "seed_tomb45_catalog", "products_added": 12, "brand": "Tomb45", "category": "wholesale_catalog"}',
  NOW()
);

COMMENT ON TABLE master_products IS 'Master product catalog for BookedBarber wholesale marketplace. Populated by CIN7 sync and manual entries.';
...
COMMENT ON COLUMN marketplace_enrollment.subscription_tier IS 'Subscription tier: free, premium, or enterprise - affects wholesale pricing';