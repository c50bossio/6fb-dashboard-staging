...
class CommissionNotificationService {
  ...
  async sendCommissionCalculated(data) {
    ...
    try {
      ...
      console.log(`📧 Commission notification sent to ${barberData.full_name}: $${commissionAmount}`)
  ...
  async sendCommissionPaid(data) {
    ...
    try {
      ...
      console.log(`✅ Commission paid notification sent to ${barberData.full_name}: $${amount}`)
  ...
  async sendPushNotification(notificationData) {
    ...
    console.log('📱 Push notification:', notificationData.title)
  }
  ...
  async sendEmailNotification(notificationData) {
    try {
      ...
      console.log('📧 Email notification sent:', notificationData.title)
    } catch (error) {
  ...
  async sendWebhookNotification(notificationData) {
    ...
    console.log('🔗 Webhook notification:', notificationData.type)
  }
  ...
  async sendDailyCommissionSummaries() {
    try {
      ...
      console.log(`📊 Daily commission summaries sent to ${balances?.length || 0} barbers`)
