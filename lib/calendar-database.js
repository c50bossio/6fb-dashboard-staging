...
export async function getCalendarEvents(barberbarbershopId, startDate, endDate) {
  ...
  try {
    const { data: appointments, error } = await supabase
      ...
      .select(`
        ...
        notes,
        barber_id,
        barbershops!appointments_barberbarbershop_id_fkey(name),
...
export async function getBarberResources(barberbarbershopId) {
  const supabase = createClient()
...
export async function getServices(barberbarbershopId) {
  const supabase = createClient()
...
export async function getRecurringAppointments(barberbarbershopId) {
  const supabase = createClient()
...
export async function seedCalendarData(barberbarbershopId) {
  const supabase = createClient()
