...
export async function getCalendarEvents(barbershopId, startDate, endDate) {
...
export async function getBarberResources(barbershopId) {
  const supabase = createClient()
...
export async function getRecurringAppointments(barbershopId) {
  const supabase = createClient()
...
export async function seedCalendarData(barbershopId) {
  const supabase = createClient()
