...
function monitorPerformanceErrors() {
  ...
  // Monitor unhandled errors (with recursion protection)
  window.addEventListener('error', (event) => {
    // Prevent infinite recursion from performance monitoring errors
    if (event.message?.includes('Maximum call stack')) return;
