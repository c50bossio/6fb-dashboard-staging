  ...
  paymentLink: (paymentLinkData) => {
    return createSuccessResponse({
      ...
      metadata: {
        ...
        barberbarbershop_id: paymentLinkData.barberbarbershop_id,
  ...
  qrPayment: (qrSessionData) => {
    return createSuccessResponse({
      ...
      metadata: {
        ...
        barberbarbershop_id: qrSessionData.barberbarbershop_id,
  ...
  terminalPayment: (terminalData) => {
    return createSuccessResponse({
      ...
      metadata: {
        ...
        barberbarbershop_id: terminalData.barberbarbershop_id,
...
export function extractPOSParams(body) {
  ...
  if (!barbershopId) {
    errors.push('barbershopId is required')
  }
