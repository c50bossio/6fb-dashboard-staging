...
// Named exports for specific contexts - commonly used loggers (lazy initialization to prevent circular dependencies)
let loggerInstances = {
  _authLogger: null,
  _dbLogger: null,
  _apiLogger: null,
...
export const authLogger = {
  get debug() { return (loggerInstances._authLogger ??= new Logger('auth')).debug },
  get info() { return (loggerInstances._authLogger ??= new Logger('auth')).info },
  get log() { return (loggerInstances._authLogger ??= new Logger('auth')).log },
  get warn() { return (loggerInstances._authLogger ??= new Logger('auth')).warn },
  get error() { return (loggerInstances._authLogger ??= new Logger('auth')).error },
  get fatal() { return (loggerInstances._authLogger ??= new Logger('auth')).fatal }
}

export const dbLogger = {
  get debug() { return (loggerInstances._dbLogger ??= new Logger('database')).debug },
  get info() { return (loggerInstances._dbLogger ??= new Logger('database')).info },
  get log() { return (loggerInstances._dbLogger ??= new Logger('database')).log },
  get warn() { return (loggerInstances._dbLogger ??= new Logger('database')).warn },
  get error() { return (loggerInstances._dbLogger ??= new Logger('database')).error },
  get fatal() { return (loggerInstances._dbLogger ??= new Logger('database')).fatal }
}

export const apiLogger = {
  get debug() { return (loggerInstances._apiLogger ??= new Logger('api')).debug },
  get info() { return (loggerInstances._apiLogger ??= new Logger('api')).info },
  get log() { return (loggerInstances._apiLogger ??= new Logger('api')).log },
  get warn() { return (loggerInstances._apiLogger ??= new Logger('api')).warn },
  get error() { return (loggerInstances._apiLogger ??= new Logger('api')).error },
  get fatal() { return (loggerInstances._apiLogger ??= new Logger('api')).fatal }
}

export const uiLogger = {
  get debug() { return (loggerInstances._uiLogger ??= new Logger('ui')).debug },
  get info() { return (loggerInstances._uiLogger ??= new Logger('ui')).info },
  get log() { return (loggerInstances._uiLogger ??= new Logger('ui')).log },
  get warn() { return (loggerInstances._uiLogger ??= new Logger('ui')).warn },
  get error() { return (loggerInstances._uiLogger ??= new Logger('ui')).error },
  get fatal() { return (loggerInstances._uiLogger ??= new Logger('ui')).fatal }
}

export const performanceLogger = {
  get debug() { return (loggerInstances._performanceLogger ??= new Logger('performance')).debug },
  get info() { return (loggerInstances._performanceLogger ??= new Logger('performance')).info },
  get log() { return (loggerInstances._performanceLogger ??= new Logger('performance')).log },
  get warn() { return (loggerInstances._performanceLogger ??= new Logger('performance')).warn },
  get error() { return (loggerInstances._performanceLogger ??= new Logger('performance')).error },
  get fatal() { return (loggerInstances._performanceLogger ??= new Logger('performance')).fatal }
}

export const securityLogger = {
  get debug() { return (loggerInstances._securityLogger ??= new Logger('security')).debug },
  get info() { return (loggerInstances._securityLogger ??= new Logger('security')).info },
  get log() { return (loggerInstances._securityLogger ??= new Logger('security')).log },
  get warn() { return (loggerInstances._securityLogger ??= new Logger('security')).warn },
  get error() { return (loggerInstances._securityLogger ??= new Logger('security')).error },
  get fatal() { return (loggerInstances._securityLogger ??= new Logger('security')).fatal }
}

export const paymentLogger = {
  get debug() { return (loggerInstances._paymentLogger ??= new Logger('payment')).debug },
  get info() { return (loggerInstances._paymentLogger ??= new Logger('payment')).info },
  get log() { return (loggerInstances._paymentLogger ??= new Logger('payment')).log },
  get warn() { return (loggerInstances._paymentLogger ??= new Logger('payment')).warn },
  get error() { return (loggerInstances._paymentLogger ??= new Logger('payment')).error },
  get fatal() { return (loggerInstances._paymentLogger ??= new Logger('payment')).fatal }
}

export const webhookLogger = {
  get debug() { return (loggerInstances._webhookLogger ??= new Logger('webhook')).debug },
  get info() { return (loggerInstances._webhookLogger ??= new Logger('webhook')).info },
  get log() { return (loggerInstances._webhookLogger ??= new Logger('webhook')).log },
  get warn() { return (loggerInstances._webhookLogger ??= new Logger('webhook')).warn },
  get error() { return (loggerInstances._webhookLogger ??= new Logger('webhook')).error },
  get fatal() { return (loggerInstances._webhookLogger ??= new Logger('webhook')).fatal }
}

export const cacheLogger = {
  get debug() { return (loggerInstances._cacheLogger ??= new Logger('cache')).debug },
  get info() { return (loggerInstances._cacheLogger ??= new Logger('cache')).info },
  get log() { return (loggerInstances._cacheLogger ??= new Logger('cache')).log },
  get warn() { return (loggerInstances._cacheLogger ??= new Logger('cache')).warn },
  get error() { return (loggerInstances._cacheLogger ??= new Logger('cache')).error },
  get fatal() { return (loggerInstances._cacheLogger ??= new Logger('cache')).fatal }
}

export const analyticsLogger = {
  get debug() { return (loggerInstances._analyticsLogger ??= new Logger('analytics')).debug },
  get info() { return (loggerInstances._analyticsLogger ??= new Logger('analytics')).info },
  get log() { return (loggerInstances._analyticsLogger ??= new Logger('analytics')).log },
  get warn() { return (loggerInstances._analyticsLogger ??= new Logger('analytics')).warn },
  get error() { return (loggerInstances._analyticsLogger ??= new Logger('analytics')).error },
  get fatal() { return (loggerInstances._analyticsLogger ??= new Logger('analytics')).fatal }
}
