...
let _authLogger, _dbLogger, _apiLogger, _uiLogger, _performanceLogger, _securityLogger, _paymentLogger, _webhookLogger, _cacheLogger, _analyticsLogger

export const authLogger = {
  get debug() { return (_authLogger ??= new Logger('auth')).debug },
  get info() { return (_authLogger ??= new Logger('auth')).info },
  get log() { return (_authLogger ??= new Logger('auth')).log },
  get warn() { return (_authLogger ??= new Logger('auth')).warn },
  get error() { return (_authLogger ??= new Logger('auth')).error },
  get fatal() { return (_authLogger ??= new Logger('auth')).fatal }
}

export const dbLogger = {
  get debug() { return (_dbLogger ??= new Logger('database')).debug },
  get info() { return (_dbLogger ??= new Logger('database')).info },
  get log() { return (_dbLogger ??= new Logger('database')).log },
  get warn() { return (_dbLogger ??= new Logger('database')).warn },
  get error() { return (_dbLogger ??= new Logger('database')).error },
  get fatal() { return (_dbLogger ??= new Logger('database')).fatal }
}

export const apiLogger = {
  get debug() { return (_apiLogger ??= new Logger('api')).debug },
  get info() { return (_apiLogger ??= new Logger('api')).info },
  get log() { return (_apiLogger ??= new Logger('api')).log },
  get warn() { return (_apiLogger ??= new Logger('api')).warn },
  get error() { return (_apiLogger ??= new Logger('api')).error },
  get fatal() { return (_apiLogger ??= new Logger('api')).fatal }
}

export const uiLogger = {
  get debug() { return (_uiLogger ??= new Logger('ui')).debug },
  get info() { return (_uiLogger ??= new Logger('ui')).info },
  get log() { return (_uiLogger ??= new Logger('ui')).log },
  get warn() { return (_uiLogger ??= new Logger('ui')).warn },
  get error() { return (_uiLogger ??= new Logger('ui')).error },
  get fatal() { return (_uiLogger ??= new Logger('ui')).fatal }
}

export const performanceLogger = {
  get debug() { return (_performanceLogger ??= new Logger('performance')).debug },
  get info() { return (_performanceLogger ??= new Logger('performance')).info },
  get log() { return (_performanceLogger ??= new Logger('performance')).log },
  get warn() { return (_performanceLogger ??= new Logger('performance')).warn },
  get error() { return (_performanceLogger ??= new Logger('performance')).error },
  get fatal() { return (_performanceLogger ??= new Logger('performance')).fatal }
}

export const securityLogger = {
  get debug() { return (_securityLogger ??= new Logger('security')).debug },
  get info() { return (_securityLogger ??= new Logger('security')).info },
  get log() { return (_securityLogger ??= new Logger('security')).log },
  get warn() { return (_securityLogger ??= new Logger('security')).warn },
  get error() { return (_securityLogger ??= new Logger('security')).error },
  get fatal() { return (_securityLogger ??= new Logger('security')).fatal }
}

export const paymentLogger = {
  get debug() { return (_paymentLogger ??= new Logger('payment')).debug },
  get info() { return (_paymentLogger ??= new Logger('payment')).info },
  get log() { return (_paymentLogger ??= new Logger('payment')).log },
  get warn() { return (_paymentLogger ??= new Logger('payment')).warn },
  get error() { return (_paymentLogger ??= new Logger('payment')).error },
  get fatal() { return (_paymentLogger ??= new Logger('payment')).fatal }
}

export const webhookLogger = {
  get debug() { return (_webhookLogger ??= new Logger('webhook')).debug },
  get info() { return (_webhookLogger ??= new Logger('webhook')).info },
  get log() { return (_webhookLogger ??= new Logger('webhook')).log },
  get warn() { return (_webhookLogger ??= new Logger('webhook')).warn },
  get error() { return (_webhookLogger ??= new Logger('webhook')).error },
  get fatal() { return (_webhookLogger ??= new Logger('webhook')).fatal }
}

export const cacheLogger = {
  get debug() { return (_cacheLogger ??= new Logger('cache')).debug },
  get info() { return (_cacheLogger ??= new Logger('cache')).info },
  get log() { return (_cacheLogger ??= new Logger('cache')).log },
  get warn() { return (_cacheLogger ??= new Logger('cache')).warn },
  get error() { return (_cacheLogger ??= new Logger('cache')).error },
  get fatal() { return (_cacheLogger ??= new Logger('cache')).fatal }
}

export const analyticsLogger = {
  get debug() { return (_analyticsLogger ??= new Logger('analytics')).debug },
  get info() { return (_analyticsLogger ??= new Logger('analytics')).info },
  get log() { return (_analyticsLogger ??= new Logger('analytics')).log },
  get warn() { return (_analyticsLogger ??= new Logger('analytics')).warn },
  get error() { return (_analyticsLogger ??= new Logger('analytics')).error },
  get fatal() { return (_analyticsLogger ??= new Logger('analytics')).fatal }
}
