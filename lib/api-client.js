...
export const aiAPI = {
  ...
  async getAnalytics(barbershopId, metrics = []) {
    return apiClient.post('/api/v1/ai/analytics', { barbershop_id: barbershopId, metrics })
  },
  
  async getRecommendations(barbershopId, category) {
    return apiClient.post('/api/v1/ai/recommendations', { barbershop_id: barbershopId, category })
  }
}
...
export const bookingAPI = {
  ...
  async getBarbershop(barbershopId) {
    return apiClient.get(`/api/v1/public/barbershops/${barbershopId}`)
  },
  
  async getBarbers(barbershopId) {
    return apiClient.get(`/api/v1/public/barbershops/${barbershopId}/barbers`)
  },
