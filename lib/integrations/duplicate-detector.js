...
export class DuplicateDetector {
   ...
   * @param {string} barberbarbershopId - Barbershop ID to check within
   * @returns {Object} Duplicate detection results
   */
  async checkDuplicates(records, entityType, barberbarbershopId) {
    const results = {
      records: [],
      stats: {
    ...
    const existing = await this.fetchExistingRecords(entityType, barberbarbershopId)
   ...
   */
  async fetchExistingRecords(entityType, barberbarbershopId) {
    let query
