 ...
 */
export async function getResolvedServices(barberId, barberbarbershopId, options = {}) {
  const {
 ...
 */
export async function getServicesForContext(barberId, barberbarbershopId, context) {
  const baseOptions = {
    includeInactive: false
  }
  ...
  switch (context) {
    case 'booking':
      return getResolvedServices(barberId, barberbarbershopId, {
        ...baseOptions,
        forBooking: true
      }).then(services => 
    ...
    case 'analytics':
      return getResolvedServices(barberId, barberbarbershopId, baseOptions)
 ...
 */
export async function getShopServicesWithCustomizations(barberbarbershopId, options = {}) {
  const supabase = createClient()
