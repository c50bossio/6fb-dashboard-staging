 ...
 */
export async function getCustomerAnalytics(barbershopId = DEMO_BARBERSHOP_ID) {
  try {
 ...
 */
export async function getAppointmentAnalytics(barbershopId = DEMO_BARBERSHOP_ID) {
  try {
 ...
 */
export async function getFinancialAnalytics(barbershopId = DEMO_BARBERSHOP_ID) {
  try {
 ...
 */
export async function getStaffAnalytics(barbershopId = DEMO_BARBERSHOP_ID) {
  try {
 ...
 */
export async function getDashboardAnalytics(barbershopId = DEMO_BARBERSHOP_ID) {
  try {
