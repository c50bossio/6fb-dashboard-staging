...
class AutomationQueueManager {
  ...
  async addJob(queueType, jobType, jobData, options = {}) {
    try {
      ...
      const job = await queue.add(jobType, {
        ...
        barbershopId: jobData.barbershopId,
  ...
  // Fee Collection Jobs
  async addFeeCollectionJob(barbershopId, appointmentId, feeAmount, paymentMethodId, options = {}) {
  ...
  // Smart Reminder Jobs
  async addReminderJob(barbershopId, appointmentId, customerId, riskScore, options = {}) {
  ...
  async addPredictionJob(barbershopId, appointmentId, dataPoints, options = {}) {
  ...
  // Recovery Flow Jobs
  async addRecoveryJob(barbershopId, customerId, blockReason, options = {}) {
  ...
  async addNotificationJob(barbershopId, userId, alertType, alertData, options = {}) {
  ...
  async addPricingJob(barbershopId, customerId, adjustmentType, adjustmentAmount, options = {}) {
  ...
  async addDepositJob(barbershopId, customerId, appointmentId, depositAmount, options = {}) {
