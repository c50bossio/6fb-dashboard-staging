...
export function createClient() {
  ...
  // Create client with implicit flow to avoid PKCE code_verifier issues
  const client = createBrowserClient(supabaseUrl, supabaseAnonKey, {
    auth: {
      flowType: 'implicit', // Changed from 'pkce' to avoid code_verifier issues
      detectSessionInUrl: true, // Automatically handle OAuth callback
      persistSession: true,
