...
// Use environment variable for salt, with a fallback that clearly indicates misconfiguration
...
class Cin7Client {
  constructor(accountId, apiKey) {
    ...
    // Use environment variable for API URL with sensible default
    const cin7BaseUrl = process.env.CIN7_API_URL || 'https://inventory.dearsystems.com'
    this.baseUrl = `${cin7BaseUrl}/externalapi`
    this.accountUrl = `${cin7BaseUrl}/ExternalApi`
  }
