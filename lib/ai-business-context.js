...
export class AIBusinessContextService {
   ...
   * @param {string} barberbarbershopId - The barbershop ID to get context for
   * @returns {object} Structured business context
   */
  async getBusinessContext(barberbarbershopId = 'default') {
    try {
      const [
        bookingsData,
        analyticsData,
        ...
        this.getBookingsContext(barberbarbershopId),
        this.getAnalyticsContext(barberbarbershopId),
        this.getCustomersContext(barberbarbershopId),
        this.getRevenueContext(barberbarbershopId),
        this.getStaffContext(barberbarbershopId)
      ])
      ...
      return this.getFallbackContext(barberbarbershopId)
    }
  }
   ...
   */
  async getBookingsContext(barberbarbershopId) {
   ...
   */
  async getAnalyticsContext(barberbarbershopId) {
    const today = new Date().toISOString().split('T')[0]
   ...
   */
  async getCustomersContext(barberbarbershopId) {
    try {
      const supabase = getSupabaseClient()
   ...
   */
  async getRevenueContext(barberbarbershopId) {
    const today = new Date().toISOString().split('T')[0]
   ...
   */
  async getStaffContext(barberbarbershopId) {
    try {
      const supabase = getSupabaseClient()
   ...
   */
  getFallbackContext(barberbarbershopId) {
    return {
      barberbarbershop_id: barberbarbershopId,
      timestamp: new Date().toISOString(),
   ...
   */
  async getAISystemPrompt(barberbarbershopId = 'default') {
