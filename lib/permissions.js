 ...
 * @param {string} barberbarbershopId - UUID of the barbershop
 * @returns {Object} Permission object or null
 */
export async function getBarberPermissions(barberId, barberbarbershopId) {
  const cacheKey = `${barberId}-${barberbarbershopId}`
 ...
 */
export async function hasPermission(barberId, barberbarbershopId, permissionName) {
  const permissions = await getBarberPermissions(barberId, barberbarbershopId)
 ...
 */
export async function hasPermissions(barberId, barberbarbershopId, permissionNames) {
  const permissions = await getBarberPermissions(barberId, barberbarbershopId)
 ...
 */
export async function validateServicePricing(barberId, barberbarbershopId, basePrice, proposedPrice) {
  const permissions = await getBarberPermissions(barberId, barberbarbershopId)
 ...
 */
export async function validateServiceDuration(barberId, barberbarbershopId, baseDuration, proposedDuration) {
  const permissions = await getBarberPermissions(barberId, barberbarbershopId)
 ...
 */
export async function applyPermissionTemplate(barberId, barberbarbershopId, templateId, grantedBy) {
  const supabase = createClient()
 ...
 */
export async function canManagePermissions(userId, barberbarbershopId) {
  const supabase = createClient()
