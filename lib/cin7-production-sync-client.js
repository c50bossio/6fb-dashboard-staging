...
class Cin7ProductionSyncClient {
   ...
   */
  async startSync(barberbarbershopId, userId, options = {}) {
    try {
   ...
   */
  async getRecentSyncs(barberbarbershopId, limit = 10) {
    try {
      const response = await fetch(`${this.baseUrl}/production-sync?barberbarbershopId=${barberbarbershopId}&limit=${limit}`)
   ...
   */
  async getSyncMetrics(barberbarbershopId, days = 7) {
    try {
      const response = await fetch(`${this.baseUrl}/sync-metrics?barberbarbershopId=${barberbarbershopId}&days=${days}`)
   ...
   */
  async getSyncAlerts(barberbarbershopId, includeResolved = false) {
    try {
   ...
   */
  async getFieldMapping(barberbarbershopId) {
    try {
      const response = await fetch(`${this.baseUrl}/field-mapping?barberbarbershopId=${barberbarbershopId}`)
   ...
   */
  async updateFieldMapping(barberbarbershopId, mappingConfig) {
    try {
   ...
   */
  async validateFieldMapping(barberbarbershopId, mappingConfig) {
    try {
   ...
   */
  async getSyncRecommendations(barberbarbershopId) {
    try {
      const response = await fetch(`${this.baseUrl}/sync-recommendations?barberbarbershopId=${barberbarbershopId}`)
