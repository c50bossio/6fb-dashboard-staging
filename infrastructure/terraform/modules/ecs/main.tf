# ECS Module for 6FB AI Agent System
# Provides container orchestration with auto-scaling and high availability
  ...
  container_definitions = jsonencode([
    {
      ...
      healthCheck = {
        command     = ["CMD-SHELL", "curl -f http://localhost:9999/api/health || exit 1"]
        interval    = 30
        timeout     = 5
        retries     = 3
        startPeriod = 60
