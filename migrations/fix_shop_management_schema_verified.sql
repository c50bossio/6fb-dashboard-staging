-- ==========================================
-- Shop Management Module - Schema Verified Migration
-- ==========================================
-- This migration uses the ACTUAL column names from your database:
-- 
-- Table               | Shop Column      | Data Type
-- ------------------- | ---------------- | ---------
-- customers           | shop_id          | text (also has barbershop_id varchar)
-- bookings            | shop_id          | text
-- services            | shop_id          | text
-- barbers             | shop_id          | text
-- barbershop_staff    | barbershop_id    | uuid
-- products            | barbershop_id    | uuid
-- transactions        | (needs checking) | unknown
...
-- ==========================================
-- PART 5: BARBERS TABLE (shop_id TEXT)
-- ==========================================
...
-- ==========================================
-- PART 6: BARBERSHOP_STAFF TABLE (barbershop_id UUID)
-- ==========================================
...
BEGIN
  ...
  IF EXISTS (
    ...
    -- Create new policies - barbershop_id is UUID
...
-- ==========================================
-- PART 7: PRODUCTS TABLE (barbershop_id UUID)
-- ==========================================
...
-- ==========================================
-- PART 8: TRANSACTIONS TABLE (check if exists and get column)
-- ==========================================
...
-- Create comprehensive dashboard view using correct column names
...
SELECT 
  ...
  -- Revenue metrics (from bookings + any transactions)
  COALESCE((
    SELECT SUM(bk.price) 
    FROM bookings bk 
    WHERE bk.shop_id::text = b.id::text 
...
-- Function to calculate shop metrics using correct column names
...
BEGIN
  ...
  RAISE NOTICE 'Schema Verified Migration Summary:';
  ...
  RAISE NOTICE '  Column names verified from actual schema';
  RAISE NOTICE '  Mixed shop_id/barbershop_id patterns handled';
  RAISE NOTICE '  Status: SUCCESS';
END $$;

SELECT 'Shop Management Schema Verified Migration Complete - All column names confirmed!' as status;