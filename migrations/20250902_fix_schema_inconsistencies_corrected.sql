-- =====================================================
-- FIX SCHEMA INCONSISTENCIES FOR LOCATION EDITING (CORRECTED)
...
-- First check if customer_id column exists, if not skip the data copy
-- =====================================================
...
-- Copy customer data to bookings table ONLY if customer_id column exists
-- This query will gracefully handle cases where the column doesn't exist
DO $$
BEGIN
    -- Check if customer_id column exists in bookings table
    IF EXISTS (
        SELECT 1 FROM information_schema.columns 
        WHERE table_name = 'bookings' 
        AND column_name = 'customer_id'
    ) THEN
        -- Update bookings with customer data if customer_id exists
        UPDATE bookings b
        SET 
...
-- =====================================================
-- SUMMARY:
-- - Safely adds customer columns to bookings table
...
-- - Gracefully handles missing customer_id column
-- =====================================================